...
const Register = () => {
    ...
    return (
        <div className='container mt-5'>
            <Formik className='card form-group' onSubmit={registerMik.handleSubmit} initialValues={{
                email: '',
                password: '',
                name: '',
                gender: true,
                ...
                <Form className="card-body">
                    <div className="row">
                        <div className="col-md-6 col-12">
                            ...
                            <Field type="email" className='form-control mb-2' id='email' name='email' onChange={registerMik.handleChange} />
                        </div>
                        <div className="col-md-6 col-12">
                            <p className='d-inline-block me-2'>Name</p> <span className='text-danger'>{registerMik.errors.name}</span>
                            <Field type="text" className='form-control mb-2' id='name' name='name' onChange={registerMik.handleChange} />
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-md-6 col-12">
                            <p className='d-inline-block me-2'>Password</p><span className='text-danger'>{registerMik.errors.password}</span>
                            <Field type="password" className='form-control mb-2' id='password' name='password' onChange={registerMik.handleChange} />
                        </div>
                        <div className="col-md-6 col-12">
                            <p className='d-inline-block me-2'>Phone</p> <span className='text-danger'>{registerMik.errors.phone}</span>
                            <Field type="number" className='form-control mb-2' id='phone' name='phone' onChange={registerMik.handleChange} />
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-md-6 col-12">
                            <p className='d-inline-block me-2'>Confirm Password</p> <span className='text-danger'>{registerMik.errors.checkpass}</span>
                            <Field type="password" className='form-control mb-2' id='checkpass' name='checkpass' onChange={registerMik.handleChange} />
                        </div>
                        <div className="col-md-6 col-12">
