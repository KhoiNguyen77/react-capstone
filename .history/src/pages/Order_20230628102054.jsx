...
const Order = () => {
    ...
    const ordersHistory = profile.ordersHistory;
                            ...
                            {ordersHistory.map(item => {
                                return <div className="card-body p-4">
                                    <div className="d-flex justify-content-between align-items-center mb-4">
                                        ...
                                        <p className="small text-muted mb-0">Receipt Date : {item.id} </p>
                                    </div>
                                        ...
                                        <div className="card-body">
                                            <div className="row">
                                                ...
                                                <div className="col-md-2">
                                                    <img src={item.orderDetail.image} className="img-fluid" alt='shoes' />
                                                </div>
                                                ...
                                                <div className="col-md-2 text-center d-flex justify-content-center align-items-center">
                                                    <p className="text-muted mb-0 small">{item.orderDetail.name}</p>
                                                </div>
                                                <div className="col-md-2 text-center d-flex justify-content-center align-items-center">
                                                    <p className="text-muted mb-0 small">{item.orderDetail.price}$</p>
                                                </div>
                                                {/* <div className="col-md-2 text-center d-flex justify-content-center align-items-center">
                                    ...
                                    <div className="card shadow-0 border mb-4">
                                        <div className="card-body">
                                            ...
                                            <div className="row d-flex align-items-center">
                                                ...
                                                <div className="col-md-10">
                                                    <div className="progress" style={{ height: 6, borderRadius: 16 }}>
                                                        <div className="progress-bar" role="progressbar" style={{ width: '20%', borderRadius: 16, backgroundColor: '#a8729a' }} aria-valuenow={20} aria-valuemin={0} aria-valuemax={100} />
                                                    </div>
                                                    <div className="d-flex justify-content-around mb-1">
                                                        <p className="text-muted mt-1 mb-0 small ms-xl-5">Out for delivary</p>
                                                        <p className="text-muted mt-1 mb-0 small ms-xl-5">Delivered</p>
