                        ...
                        <Formik
                            ...
                            <Form className="col-lg-8 col-12">
                                <div className="row">
                                    ...
                                    <div className="col-md-6 col-12"> <ErrorMessage name='name'></ErrorMessage>
                                ...
                                <div className="row">
                                    <div className="col-md-6 col-12"> <ErrorMessage name='password'></ErrorMessage>
                                    ...
                                    <div className="col-md-6 col-12"> <ErrorMessage name='phone'></ErrorMessage>
                                ...
                                <div className="row">
                                    <div className="col-md-6 col-12"> <ErrorMessage name='checkpass'></ErrorMessage>
