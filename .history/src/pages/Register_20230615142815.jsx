                ...
                <div className="card-body">
                    <div className="row">
                        <div className="col-md-6 col-12">
                            <p className='d-inline-block mx-3'>Email</p> <span className='text-danger'>{registerMik.errors.email}</span>
                            <input type="email" className='form-control mb-2' id='email' name='email' onChange={registerMik.handleChange} />
                        </div>
                        <div className="col-md-6 col-12">
                            <p className='d-inline-block mx-3'>Name</p> <span className='text-danger'>{registerMik.errors.name}</span>
                            <input type="text" className='form-control mb-2' id='name' name='name' onChange={registerMik.handleChange} />
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-md-6 col-12">
                            <p className='d-inline-block mx-3'>Password</p><span className='text-danger'>{registerMik.errors.password}</span>
                            <input type="password" className='form-control mb-2' id='password' name='password' onChange={registerMik.handleChange} />
                        </div>
                        <div className="col-md-6 col-12">
                            <p className='d-inline-block mx-3'>Phone</p> <span className='text-danger'>{registerMik.errors.phone}</span>
                            <input type="number" className='form-control mb-2' id='phone' name='phone' onChange={registerMik.handleChange} />
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-md-6 col-12">
                            <p className='d-inline-block mx-3'>Confirm Password</p>
                            <input type="password" className='form-control mb-2' id='confirm-pass' name='confirm-pass' onChange={registerMik.handleChange} />
                        </div>
                        <div className="col-md-6 col-12">
                            <p className='d-inline-block mx-3'>Gender</p><span className='text-danger'>{registerMik.errors.gender}</span>
