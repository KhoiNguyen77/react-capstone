                            ...
                            <Form className="col-lg-8 col-12">
                                ...
                                <div className="row">
                                    <div className="col-md-6 col-12"> 
                                        ...
                                        <Field type="password" className='form-control mb-2' id='password' name='password' value={userProfile?.password}/>
                                    </div>
                                    <div className="col-md-6 col-12"> 
                                ...
                                <div className="row">
                                    <div className="col-md-6 col-12"> 
                                        ...
                                        <Field type="password" className='form-control mb-2' id='checkpass' name='checkpass' value={userProfile?.checkpass}/>
                                    </div>
                                    <div className="col-md-6 col-12">
