        ...
        <div className='container mt-5'>
            <form className='card form-group w-50 mx-auto'>
                ...
                <div className="card-body">
                    ...
                    <div className="row text-end underline-none">
                        <NavLink to={"/register"} className={'link-secondary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover'}>Register Now ?</NavLink>
                    </div>
                </div>
