...
const UpdateProfile = () => {
    const { userUpdate, userProfile } = useSelector(state => state.userReducer)
                        ...
                        <div className="col-lg-8 col-12">
                            ...
                            <div className="row">
                                <div className="col-md-6 col-12">
                                    ...
                                    <input type="password" className='form-control mb-2' id='password' name='password' onChange={updateMik.handleChange} defaultValue={userUpdate?.password} />
                                </div>
                                <div className="col-md-6 col-12">
                            ...
                            <div className="row">
                                <div className="col-md-6 col-12">
                                    ...
                                    <input type="password" className='form-control mb-2' id='checkpass' name='checkpass' onChange={updateMik.handleChange} defaultValue={userUpdate?.checkpass} />
                                </div>
                                <div className="col-md-6 col-12">
