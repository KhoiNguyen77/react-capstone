                            ...
                            <Form className="col-lg-8 col-12">
                                <div className="row">
                                    <div className="col-md-6 col-12">
                                        <p className='d-inline-block me-2'>Email</p> <ErrorMessage name='email' className='text-danger'>{msg => <div style={{ color: 'red' }}>{msg}</div>}</ErrorMessage>
                                        <Field type="email" className='form-control mb-2' id='email' name='email' value={userProfile?.email} />
                                    </div>
                                    <div className="col-md-6 col-12">
                                        <p className='d-inline-block me-2'>Name</p> <ErrorMessage name='name'></ErrorMessage>
                                        <Field type="text" className='form-control mb-2' id='name' name='name' value={userProfile?.name} />
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-md-6 col-12">
                                        <p className='d-inline-block me-2'>Password</p> <ErrorMessage name='password'></ErrorMessage>
                                        <Field type="password" className='form-control mb-2' id='password' name='password' />
                                    </div>
                                    <div className="col-md-6 col-12">
                                        <p className='d-inline-block me-2'>Phone</p> <ErrorMessage name='phone'></ErrorMessage>
                                        <Field type="number" className='form-control mb-2' id='phone' name='phone' value={userProfile?.phone} />
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-md-6 col-12">
                                        <p className='d-inline-block me-2'>Confirm Password</p> <ErrorMessage name='checkpass'></ErrorMessage>
                                        <Field type="password" className='form-control mb-2' id='checkpass' name='checkpass' />
                                    </div>
                                    <div className="col-md-6 col-12">
                                        <p className='me-2'>Gender</p> <ErrorMessage name='gender'></ErrorMessage>
