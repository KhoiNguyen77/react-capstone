            ...
            <form className='card form-group' onSubmit={registerMik.handleSubmit}>
                ...
                <div className="card-body">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 col-12">
                            <p>Gender</p><span className='text-danger'>{registerMik.errors.gender}</span>
