                        ...
                        <div className="col-lg-8 col-12">
                            <div className="row">
                                <div className="col-md-6 col-12">
                                    ...
                                    <input type="email" className='form-control mb-2' id='email' name='email' onChange={updateMik.handleChange} defaultValue={userProfile?.email} />
                                </div>
                                <div className="col-md-6 col-12">
                                    <p className='d-inline-block me-2'>Name</p> <span className='text-danger'>{updateMik.errors.name}</span>
                                    <input type="text" className='form-control mb-2' id='name' name='name' onChange={updateMik.handleChange} defaultValue={userProfile?.name} />
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-md-6 col-12">
                                    <p className='d-inline-block me-2'>Password</p><span className='text-danger'>{updateMik.errors.password}</span>
                                    <input type="password" className='form-control mb-2' id='password' name='password' onChange={updateMik.handleChange} defaultValue={userProfile?.password} />
                                </div>
                                <div className="col-md-6 col-12">
                                    <p className='d-inline-block me-2'>Phone</p> <span className='text-danger'>{updateMik.errors.phone}</span>
                                    <input type="number" className='form-control mb-2' id='phone' name='phone' onChange={updateMik.handleChange} defaultValue={userProfile?.phone} />
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-md-6 col-12">
                                    <p className='d-inline-block me-2'>Confirm Password</p> <span className='text-danger'>{updateMik.errors.checkpass}</span>
                                    <input type="password" className='form-control mb-2' id='checkpass' name='checkpass' onChange={updateMik.handleChange} defaultValue={userProfile?.checkpass} />
                                </div>
                                <div className="col-md-6 col-12">
                                    <p className='me-2'>Gender</p>
                                    <Radio.Group id='gender' name='gender' defaultValue={userProfile?.gender} onChange={updateMik.handleChange} >
